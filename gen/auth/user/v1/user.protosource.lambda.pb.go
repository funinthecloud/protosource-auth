...
// with the canonical function name "auth.user.v1.{CommandMessageName}"
...
func (h *Handler) RegisterRoutes(router *protosource.Router) {
	...
	router.Handle("GET", "auth/user/v1/get/{id}", h.HandleGetMaterialized)
...
// HandleGet retrieves the current state of a User aggregate.
...
// HandleGetMaterialized retrieves the User aggregate from the materialized store.
