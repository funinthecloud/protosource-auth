...
// with the canonical function name "auth.role.v1.{CommandMessageName}"
...
func (h *Handler) RegisterRoutes(router *protosource.Router) {
	...
	router.Handle("GET", "auth/role/v1/get/{id}", h.HandleGetMaterialized)
...
// HandleGet retrieves the current state of a Role aggregate.
...
// HandleGetMaterialized retrieves the Role aggregate from the materialized store.
